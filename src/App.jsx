        ...
        <div className="containlink">
          <div className= "row">
            ...
            <div className="col-md-8 col-sm-10">
              <h1 className="tm-home-title"><strong>Princess Olingay</strong></h1>
                  ...
                  <div className="iso-box-wrapper col4-iso-box">
                    <div className="iso-box html photoshop wordpress mobile col-md-3 col-sm-3 col-xs-12">
                      <div className="portfolio-thumb">
                        <img src="images/portfolio-img1.jpg" className="fluid-img" alt="portfolio img" />
                    ...
                    <div className="iso-box html wordpress mobile col-md-3 col-sm-3 col-xs-12">
                      <div className="portfolio-thumb">
                        <img src="images/portfolio-img2.jpg" className="fluid-img" alt="portfolio img" />
                        <div className="portfolio-overlay">
                          <h3 className="portfolio-item-title">UX Design</h3>
                          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
                        </div>
                    ...
                    <div className="iso-box wordpress col-md-3 col-sm-3 col-xs-12">
                      <div className="portfolio-thumb">
                        <img src="images/portfolio-img3.jpg" className="fluid-img" alt="portfolio img" />
                        <div className="portfolio-overlay">
                          <h3 className="portfolio-item-title">UX Design</h3>
                          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
                        </div>
                    ...
                    <div className="iso-box html mobile col-md-3 col-sm-3 col-xs-12">
                      <div className="portfolio-thumb">
                        <img src="images/portfolio-img4.jpg" className="fluid-img" alt="portfolio img" />
                        <div className="portfolio-overlay">
                          <h3 className="portfolio-item-title">UX Design</h3>
                          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
                        </div>
                    ...
                    <div className="iso-box wordpress col-md-3 col-sm-3 col-xs-12">
                      <div className="portfolio-thumb">
                        <img src="images/portfolio-img5.jpg" className="fluid-img" alt="portfolio img" />
                        <div className="portfolio-overlay">
                          <h3 className="portfolio-item-title">UX Design</h3>
                          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
                        </div>
                    ...
                    <div className="iso-box html photoshop col-md-3 col-sm-3 col-xs-12">
                      <div className="portfolio-thumb">
                        <img src="images/portfolio-img6.jpg" className="fluid-img" alt="portfolio img" />
                        <div className="portfolio-overlay">
                          <h3 className="portfolio-item-title">UX Design</h3>
                          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
                        </div>
                    ...
                    <div className="iso-box photoshop col-md-3 col-sm-3 col-xs-12">
                      <div className="portfolio-thumb">
                        <img src="images/portfolio-img7.jpg" className="fluid-img" alt="portfolio img" />
                        <div className="portfolio-overlay">
                          <h3 className="portfolio-item-title">UX Design</h3>
                          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
                        </div>
                    ...
                    <div className="iso-box wordpress col-md-3 col-sm-3 col-xs-12">
                      <div className="portfolio-thumb">
                        <img src="images/portfolio-img8.jpg" className="fluid-img" alt="portfolio img" />
                        <div className="portfolio-overlay">
                          <h3 className="portfolio-item-title">UX Design</h3>
                          <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonumm.</p>
                        </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6 col-sm-6">
              ...
              <div className="progress tm-progress">
                <div className="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style={{"width": "100%"}}></div>
              </div>
              <h4 className="tm-progress-label">HTML5 <small className="progress-percent-small">90%</small></h4>
              <div className="progress tm-progress">
                <div className="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style={{"width": "90%;"}}></div>
              </div>
